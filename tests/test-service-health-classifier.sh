...
assert_class TRANSIENT required running required none missing none 0 180 2
assert_class FAIL_PERSISTENT required running required none missing none 180 180 2
